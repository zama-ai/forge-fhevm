...
/**
 * @dev End-to-end check that a downstream repo can inherit FhevmTest while pinning its own
 * (newer) OpenZeppelin. `make check-consumer-graph` proves the same invariant statically and
 * precisely; this fixture additionally exercises the packaging — remappings, relative imports
 * and the generated bytecode actually resolving from an installed dependency directory.
 */
